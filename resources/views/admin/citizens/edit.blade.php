    ...
    <form action="{{ route('admin.citizens.update', $citizen) }}" method="POST">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 24px;">
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" value="{{ old('name', $citizen->name) }}" required
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="phone" value="{{ old('phone', $citizen->phone) }}" required
                       style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="customer_no" value="{{ old('customer_no', $citizen->customer_no) }}" required
                       style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="aadhar_card" value="{{ old('aadhar_card', $citizen->aadhar_card) }}" maxlength="12"
                       style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <select name="demand_id" style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px; background: white;">
                    ...
                    @foreach($demands as $demand)
                        <option value="{{ $demand->id }}" {{ old('demand_id', $citizen->demand_id) == $demand->id ? 'selected' : '' }}>
                            {{ $demand->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group" style="margin-bottom: 20px; grid-column: span 2;">
                ...
                <textarea name="address" rows="3"
                          style="width: 100%; padding: 12px; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 14px;">{{ old('address', $citizen->address) }}</textarea>
