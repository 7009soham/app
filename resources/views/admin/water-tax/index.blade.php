...
@section('title', 'Water Tax Management')
...
<div class="page-header">
    ...
    <div class="header-actions">
        ...
        <a href="{{ route('admin.water-tax.create') }}" class="btn btn-primary">
...
<div class="filters-card">
    <form method="GET" action="{{ route('admin.water-tax.index') }}">
        <div class="filters-row">
            ...
            <a href="{{ route('admin.water-tax.index') }}" class="filter-btn reset">Reset</a>
        </div>
    </form>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions-cell">
                            ...
                            <form action="{{ route('admin.water-tax.destroy', $record) }}" method="POST" 
