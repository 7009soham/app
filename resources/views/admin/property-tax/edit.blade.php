        ...
        <div class="form-body">
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="customer_no" class="form-input" value="{{ old('customer_no', $propertyTaxRecord->customer_no) }}" required>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="phone" class="form-input" value="{{ old('phone', $propertyTaxRecord->phone) }}" maxlength="10">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="monthly_bill" class="form-input" value="{{ old('monthly_bill', $propertyTaxRecord->monthly_bill) }}" step="0.01" required>
                </div>
                <div class="form-group">
                    <label class="form-label">Period</label>
                    <input type="text" name="period" class="form-input" value="{{ old('period', $propertyTaxRecord->period) }}">
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount_paid" class="form-input" value="{{ old('amount_paid', $propertyTaxRecord->amount_paid) }}" step="0.01">
                </div>
            </div>
