...
<div class="page-header-card">
    <div class="header-content">
        ...
        <div class="header-text">
            <h2>Property Tax Records</h2>
            <p>View and manage your property tax bills and payments</p>
        </div>
    </div>
</div>
...
<div class="summary-row">
    ...
    <div class="summary-card">
        ...
        <div class="summary-info">
            ...
            <div class="summary-value">₹{{ number_format($propertyTaxRecords->sum('amount_paid'), 2) }}</div>
        </div>
    </div>
</div>
...
<div class="records-card">
    <div class="records-header">
        <h3 class="records-title">All Property Tax Records</h3>
    </div>
    ...
    <div class="empty-state">
        <i class="fas fa-home"></i>
        <h3>No Property Tax Records Found</h3>
        <p>There are no property tax records associated with your account. Please contact the Gram Panchayat office if you believe this is an error.</p>
    </div>
    @endif
</div>
@endsection
