...
<head>
    ...
    <title>मूल्यांकन यादी - {{ $assessment->property_number }} (अनधिकृत)</title>
...
<body>
    <!-- Watermark -->
    <div class="watermark">NOT FOR OFFICIAL USE</div>
    <div class="watermark-secondary">सरकारी वापरासाठी नाही</div>
    <div class="watermark-tertiary">NOT FOR OFFICIAL USE</div>

    <!-- Buttons -->
    <a href="{{ route('citizen.property-assessment.index') }}" class="back-btn no-print">
    ...
    <div class="print-container">
        ...
        <div class="unofficial-notice">
            ⚠️ हे मूल्यांकन सरकारी वापरासाठी नाही | This Assessment is NOT FOR OFFICIAL USE ⚠️
        </div>
